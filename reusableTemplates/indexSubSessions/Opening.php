                ...
                <div class="d-flex flex-column flex-lg-row">
                    <div>
                        ...
                        <span class="animated fadeInUp delay-10s">
                            ...
                            </div><!-- end of Technology client list -->
                            <div class="table-responsive text-black text-left">
                                <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                            ...
                            </div><!-- end of manufacturing client list -->
                            <div class="table-responsive text-black text-left">
                                <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="https://www.bigglesfm.com">
                                                        <img class="radio-logo-size" src="../../images/clientLogos/Radio/bigglesFM.png" alt="biggles fm logo">
                                                    </a>
                                                </td>
                                                <td>Biggles FM, UK: presentation</td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="https://www.facebook.com/1450koko/">
                                                        <img class="radio-logo-size" src="../../images/clientLogos/Radio/300px-KOKO-AM_1450_radio_logo.png" alt="KOKO FM logo">
                                                    </a>
                                                </td>
                                                <td>KOKO, USA: Station management & presentation</td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="https://www.orf.at">
                                                        <img class="radio-logo-size" src="../../images/clientLogos/Radio/ORF_Blue_Danube_Radio.png" alt="ORF logo">
                                                    </a>
                                                </td>
                                                <td>Blue Danube Radio (ORF), Austria: presentation</td>
                                            </tr>
                                            <tr>
                                                <td>
