<span class="col-lg-8 float-right">
    ...
    <div id="UniControls" class="carousel slide" data-ride="carousel">
        <!-- Indicators -->
<!--        <ol class="carousel-indicators margin-top-10" id="caInd2">-->
...
<!--            <li data-target="#UniControls" data-slide-to="3"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="4"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="5"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="6"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="7"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="8"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="9"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="10"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="11"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="12"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="13"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="14"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="15"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="16"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="17"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="18"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="19"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="20"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="21"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="22"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="23"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="24"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="25"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="26"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="27"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="28"></li>-->
<!--            <li data-target="#UniControls" data-slide-to="29"></li>-->
<!--        </ol>-->
        <!-- Images -->
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img id="uni05" src="../../../images/RobertPics/UniPics/European%20DSP%20Education%20and%20Research%20Symposium%20(EDERS)%202008,%20Tel%20Aviv,%20Israel.jpg" class="img-fluid" alt="European DSP Education and Research Symposium (EDERS) 2008, Tel Aviv, Israel">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img id="uni07" src="../../../images/RobertPics/UniPics/Lunch%20and%20learn%20at%20Imagination%20Technologies%20(UK%202015).JPG" class="img-fluid" alt="Lunch and learn at Imagination Technologies (2015)">
                <div class="carousel-caption d-none d-md-block">
                    <p>Lunch and learn at Imagination Technologies (UK 2015)</p>
                </div>
            </div>
            <div class="carousel-item">
            ...
            <div class="carousel-item">
                <img id="uni27" src="../../../images/RobertPics/UniPics/Seminar%20at%20University%20of%20Beira%20Interior,%20Covilha,%20Portugal%20(2007).jpg" class="img-fluid" alt="Seminar at University of Beira Interior, Covilha, Portugal (2007)">
                <div class="carousel-caption d-none d-md-block">
                    <p>Seminar at University of Beira Interior, Covilha, Portugal (2007)</p>
                </div>
            </div>
            <div class="carousel-item">
                <img id="uni28" src="../../../images/RobertPics/UniPics/New%20Lab%20Opening,%20Loughborough%20University,%20UK%20(2011).jpg" class="img-fluid" alt="New Lab Opening, Loughborough University, UK (2011)">
                <div class="carousel-caption d-none d-md-block">
                    <p>New Lab Opening, Loughborough University, UK (2011)</p>
                </div>
            </div>
            <div class="carousel-item">
                <img id="uni29" src="../../../images/RobertPics/UniPics/New%20Clean%20Room%20in%20the%20Biomedical%20Institute%20of%20the%20University%20of%20the%20Bosphorus,%20Istanbul,%20Turkey%20(2011).jpg" class="img-fluid" alt="New Clean Room in the Biomedical Institute of the University of the Bosphorus, Istanbul, Turkey (2011)">
                <div class="carousel-caption d-none d-md-block">
                    <p>New Clean Room in the Biomedical Institute of the University of the Bosphorus, Istanbul, Turkey (2011)</p>
                </div>
            </div>
            <div class="carousel-item">
                <img id="uni30" src="../../../images/RobertPics/UniPics/University%20Programme%20Seminar%20by%20RO%20in%20Russia%20September%202017.JPG" class="img-fluid" alt="University Programme Seminar by RO in Russia September 2017">
                <div class="carousel-caption d-none d-md-block">
                    <p>University Programme Seminar by RO in Russia September 2017</p>
                </div>
            </div>
            <div class="carousel-item">
                <img id="uni31" src="../../../images/RobertPics/UniPics/Power%20Lab,%20Technical%20University%20of%20Cluj-Napoca,%20Romania%20(2011).jpg" class="img-fluid" alt="Power Lab, Technical University of Cluj-Napoca, Romania (2011)">
                <div class="carousel-caption d-none d-md-block">
        ...
        <!-- left and right arrows controllers -->
        <a class="carousel-control-prev" data-target="#UniControls" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" data-target="#UniControls" role="button" data-slide="next">
